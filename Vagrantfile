Vagrant::Config.run do |config|
  ...
  config.vm.define :percona1 do |percona1_config|
	...
	percona1_config.vm.host_name = "percona1"
        ...
        percona1_config.vm.forward_port "http", 3000, 3000
  ...
  config.vm.define :percona4 do |percona4_config|
	...
	#percona4_config.vm.network("192.168.70.2")
	#percona4_config.vm.boot_mode = :gui
	percona4_config.vm.customize do |percona4_vm|
        	percona4_vm.memory_size = 190
    	end
